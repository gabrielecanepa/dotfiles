...
Before proposing any commit action, read `~/.agents/references/commit-handoff.md` completely and render the handoff exactly in its format; never propose from memory of it. Follow the repository's commit convention.
